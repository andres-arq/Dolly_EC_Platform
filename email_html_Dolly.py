...
#
# El cierre del mensaje siempre es "Te esperamos en dolly.cl" en texto plano
# (sin link) — reemplaza el CTA específico de cada plantilla, que ya no tenía
# sentido como texto sin nada que apretar.
#
...
{html_parrafos}
            <p style="margin:8px 0 0 0; font-size:16px; font-weight:bold; color:{NEGRO};">{MENSAJE_CIERRE_FIJO}</p>
          </td>
        </tr>
        <tr>
